...
const graphData = {
  ...
  "items": [{
    ...
    "items": [{
      ...
      "name": "Nokia 3200/3220",
      "count": "16509186"
    }, {
      "name": "Nokia 6230/6233",
      "count": "15754859"
    }, {
      "name": "Samsung SGH-T100",
      "count": "14538321"
    ...
    "items": [{
      ...
      "name": "Nokia 1600/1650",
      "count": "46977958"
    }, {
      "name": "Motorola c139/c200",
      "count": "43687523"
    }, {
      "name": "Nokia 1100",
      "count": "43014984"
    ...
    "items": [{
      ...
      "name": "Nokia 6070/7080",
      "count": "29143945"
    }, {
      "name": "Nokia 7360/7370/7380",
      "count": "25690475"
    }, {
      "name": "Nokia 1200",
      "count": "24984234"
    ...
    "items": [{
      ...
      "name": "Nokia 6070/6080",
      "count": "17086434"
    }, {
      "name": "Nokia 7360/7370/7380",
      "count": "15840668"
    }, {
      "name": "Sony Ericsson w300",
      "count": "14698357"
    }]
  }, {
    "name": "2009",
...
/* harmony default export */ __webpack_exports__["default"] = (graphData);
...
/* harmony import */ var _Color__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Color */ "./src/Graph/Color.js");


class Bar {
  constructor(options = {}) {
    this.options = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.merge(this.options, {
      color: _Color__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomColor(),
      count: 0,
      currentCount: 0,
      endCount: 0
    });
...
const colorGenerator = function () {
  let colors = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#911eb4', '#42d4f4', '#f032e6', '#bfef45', '#fabebe', '#469990', '#e6beff', '#9A6324', '#fffac8', '#800000', '#aaffc3', '#808000', '#ffd8b1', '#000075', '#a9a9a9'];
  let colorIndex = 0;
  return {
    getRandomColor() {
...
/* harmony default export */ __webpack_exports__["default"] = (Object.create(colorGenerator));
...
/* harmony import */ var _Data_SmartPhones__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Data/SmartPhones */ "./src/Data/SmartPhones.js");
/* harmony import */ var _colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./colors */ "./src/colors.js");
/* harmony import */ var _Graph_Bar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Graph/Bar */ "./src/Graph/Bar.js");
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  ...
  let barsDiv = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#bars');
  let xAxisDiv = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#x-axis-list');
  let maxItems = 10;
  let itemHeight = 0;
  ...
  shuffle(_colors__WEBPACK_IMPORTED_MODULE_3__["default"]);
  let colorIndex = 0;
  function getRandomColor() {
    let color = _colors__WEBPACK_IMPORTED_MODULE_3__["default"][colorIndex % _colors__WEBPACK_IMPORTED_MODULE_3__["default"].length];
    colorIndex = (colorIndex + 1) % _colors__WEBPACK_IMPORTED_MODULE_3__["default"].length;
    return color;
  }
  let keyValueItems = {};
  let items = [];
  ...
  function updateXAxis(xAxisData) {
    items.sort(function (a, b) {
      if (a.currentCount > b.currentCount) return -1;
      if (a.currentCount < b.currentCount) return 1;
      return 0;
    });
    ...
    for (let i = 0; i < initXAxisValues.length; i++) {
      ...
      let xAxisElement = jquery__WEBPACK_IMPORTED_MODULE_1___default()(getXAxisElement());
  ...
  function init() {
    let initData = _Data_SmartPhones__WEBPACK_IMPORTED_MODULE_2__["default"]['items'][0];
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#graph--year').html(initData['name']);
    ...
    for (let i = 0; i < numberOfBars; i++) {
      ...
      items.push(item);
      let element = jquery__WEBPACK_IMPORTED_MODULE_1___default()(getBarElement());
    ...
    function moveStep() {
      let bars = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.bar1');
      let finished = true;
      items.sort(function (a, b) {
        if (a.currentCount > b.currentCount) return -1;
        if (a.currentCount < b.currentCount) return 1;
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default.a.each(bars, function (index, element) {
        let bar = jquery__WEBPACK_IMPORTED_MODULE_1___default()(element);
        ...
        if (nextPeriodIndex >= _Data_SmartPhones__WEBPACK_IMPORTED_MODULE_2__["default"]['items'].length) {
          if (item['currentTop'] !== item['endTop']) {
            finished = false;
          }
        }
      });
      updateXAxis(_Data_SmartPhones__WEBPACK_IMPORTED_MODULE_2__["default"]['items'][nextPeriodIndex - 1]['x-axis']);
      return finished;
    }
    ...
    function startNextPeriod() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('#clock').addClass('clock1');
      let nextPeriod = _Data_SmartPhones__WEBPACK_IMPORTED_MODULE_2__["default"]['items'][nextPeriodIndex];
      let nextItems = nextPeriod['items'];
      if (nextPeriod['name'] !== undefined) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#graph--year').html(nextPeriod['name']);
      }
      for (let i = 0; i < items.length; i++) {
      ...
      itemHeight = barsDiv.height() / maxItems;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.bar1').css('height', itemHeight + 'px');
      nextPeriodIndex++;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-period="' + (nextPeriodIndex - 3) + '"]').remove();
      return true;
    }
    setTimeout(function () {
      moveStep();
  ...
  function getBarElement() {
    return '<div class="bar1">' + '<div class="bar1--content">' + '<div class="bar1--progress"></div>' + '<div class="bar1--details">' + '<div class="bar1--name"></div>' + '<div class="bar1--image"></div>' + '<div class="bar1--count"></div>' + '</div>' + '</div>' + '</div>';
  }
